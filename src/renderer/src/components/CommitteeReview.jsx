...
const CommitteeReview = ({ artifacts, prediction }) => {
  ...
  return (
    <div className="bg-[#0d1117] border border-gray-800 rounded-lg p-8">
      <h2 className="text-[10px] font-bold tracking-[0.2em] text-blue-500 mb-8 flex items-center justify-between">
      ...
      <div className="space-y-6">
        {sortedModels.length > 0 ? (
            ...
            <div key={i} className="space-y-2 group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-black text-gray-300 tracking-widest">{model.name}</span>
                </div>
          ...
          <div className="py-12 flex flex-col items-center justify-center text-center opacity-30">
            ...
            <p className="text-[8px] font-bold text-gray-500 tracking-widest">Committee Offline</p>
          </div>
        )}
      </div>
    </div>
