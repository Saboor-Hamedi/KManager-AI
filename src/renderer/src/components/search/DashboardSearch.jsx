  ...
  return (
    ...
    {selectedPdf && (
      <>
        {/* Resize Handle */}
        <div
          className="w-1 cursor-col-resize hover:bg-[var(--text-accent)] border-l border-[var(--border-subtle)] bg-[var(--bg-panel)] transition-colors relative z-40 flex items-center justify-center shrink-0"
